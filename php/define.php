...
// Define urls
define('PHOTOS_MANAGER_URL_UPLOADS_BIG', 'uploads/big/');
define('PHOTOS_MANAGER_URL_UPLOADS_MEDIUM', 'uploads/medium/');
define('PHOTOS_MANAGER_URL_UPLOADS_THUMB', 'uploads/thumb/');
