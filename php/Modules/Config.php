...
final class Config {
	 ...
	 */
	public static function create($host, $user, $password, $name = 'photos_manager', $prefix = '') {
...
?>";
		...
		// Save file
		if (@file_put_contents(PHOTOS_MANAGER_CONFIG_FILE, $config)===false) return 'Warning: Could not create file!';
	...
	public static function exists() {
		...
		return file_exists(PHOTOS_MANAGER_CONFIG_FILE);
